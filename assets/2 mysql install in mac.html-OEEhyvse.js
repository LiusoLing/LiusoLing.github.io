import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as n,e,a as l,f as i}from"./app-VOnEDp85.js";const r={},c=l("p",null,"由于个人使用Mac电脑，这里记录下在 MacOS 下的 MySQL 的安装和卸载教程。",-1),t=i(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>安装 MySQL 前，如果电脑已经正确装有 MySQL，那么这篇文章可以略过不看。</p><p>书接上文，当我想在控制台用 MySQL 命令进行数据导入时，发现提示我 MySQL 命令不存在：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Last login: Mon Dec  <span class="token number">4</span> <span class="token number">11</span>:00:35 on ttys001
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>至此，MySQL 安装完毕。</p>`,33);function o(d,p){return a(),n("div",null,[c,e(" more "),t])}const v=s(r,[["render",o],["__file","2 mysql install in mac.html.vue"]]);export{v as default};
